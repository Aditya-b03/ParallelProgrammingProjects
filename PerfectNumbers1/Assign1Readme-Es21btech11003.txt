1. Program evaluates of Perfect number between 1 to N.
...
Program creates K child processes which shares memory with parent process.
Each child process evaluate a subset of values of number between 1 to N.
